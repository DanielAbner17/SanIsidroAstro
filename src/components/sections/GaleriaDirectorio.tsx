...
const CATEGORY_COLORS = {
  'Restaurantes y Alimentos': 'bg-[#fcc52a]',
  'Salud y Belleza': 'bg-[#8ea8db]',
  Mascotas: 'bg-[#fe679a]',
  'Bancos y Servicios Financieros': 'bg-[#0eaf90]',
  'Servicios y Tienda departamental': 'bg-[#4a08a0]',
  Autoservicio: 'bg-[#6aff00]',
  Otros: 'bg-gray-500',
};
